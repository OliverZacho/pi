  ...
  return (
    <main className="admin-page">
      ...
      <section className="card">
        ...
        <p>Generates a unique sender like <code>company-yyyymmdd@pirol.app</code> for each newsletter signup.</p>
      ...
      <section className="card">
        ...
        {overview.emails.length === 0 ? (
          <p>No emails ingested yet. Post to <code>/api/webhooks/resend</code> to test.</p>
        ) : (
          <table>
            <thead>
              <tr>
